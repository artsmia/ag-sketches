...
L.Draw.Feature = L.Handler.extend({
	...
	_fireCreatedEvent: function (layer, drawOptions) {
        if (drawOptions.repeatMode) {
            window.repeatedDraws = window.repeatedDraws || [];
            layer.temporary = true;
            window.repeatedDraws.push(layer);
        }
	...
	_cancelDrawing: function (e) {
        ...
        if (window.repeatedDraws && window.repeatedDraws.length > 0) {
            console.log('_cancelDrawing', window.repeatedDraws);
            this._map.fire('draw:repeatstop', { layers: window.repeatedDraws });
            window.repeatedDraws = null;
        }
	}
});
...
L.Draw.Polyline = L.Draw.Feature.extend({
	...
	_fireCreatedEvent: function () {
		...
		L.Draw.Feature.prototype._fireCreatedEvent.call(this, poly, this.options);
	}
});
...
L.Draw.Rectangle = L.Draw.SimpleShape.extend({
	...
	_fireCreatedEvent: function () {
		...
		L.Draw.SimpleShape.prototype._fireCreatedEvent.call(this, rectangle, this.options);
	}
});
